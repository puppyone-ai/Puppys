from puppy_new.tools.defaultTools.talk_with_human import TalkWithHuman
from puppy_new.tools.defaultTools.search import Search
from puppy_new.tools.defaultTools.large_language_model import LLM
