...
def decisiontree(self):
    # import random
    # print(self.puppy_vars.runtime_dict)
    # self.random = random
    self.do_check("Output a list of 10 random numbers from 1 to 100", show_response=True)
    # self.do_check("Output a random numbers from 1 to 100", show_response=True)
