...
class Action:
    ...
    def replace_action_code(self, new_code: str) -> None:
        """
        ...
        if self.action_name in self._puppy_instance.actionflow.temp_current_code and self._puppy_instance.actionflow.temp_current_code[self.action_name][1] in self._puppy_instance.actionflow.current_code:
    ...
    def get_concise_traceback(self, exc: Exception, num_of_lines: int = 10) -> str:
        """
    ...
    def highlighting(self, action_type: str, prompt: str, prompt_action: str = "") -> None:
        """
    ...
    def llm_api_call(self, prompt: str, temperature: float = 0.1, max_tokens: int = 4096) -> str:
        """
    ...
    def clean_llm_code(self, new_code: str, add_code: bool) -> str:
        """
    ...
    def run_without_errors(self, new_code: str) -> str:
        """
    ...
    def run_with_errors(self, error_message: Exception) -> str:
        """
        Run the Agent's code with errors catched by Exceptions.
        """
